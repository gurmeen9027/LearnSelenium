...
public class ECommercedemo {
	...
	// Logs
	static Logger logger = Logger.getLogger(ECommercedemo.class);
	...
	public static void main(String[] args) throws IOException {
		...
		ExtentReports Report = new ExtentReports(
				System.getProperty("user.dir") + "/Reports" + "/EcommerceReports_" + getTimeStamp() + ".html");
		...
		startTest.log(LogStatus.PASS, "Navigation to Login Page successful",
				"Passed" + startTest.addScreenCapture(getScreenShot()));
		...
		if (ele.equals(null)) {
			...
			startTest.log(LogStatus.PASS, "User login successful",
					"Passed" + startTest.addScreenCapture(getScreenShot()));
		}
	...
	public static String getScreenShot() throws IOException {
		logger.info("start of getscreenshot");
