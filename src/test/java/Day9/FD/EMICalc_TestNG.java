...
public class EMICalc_TestNG {
  
	static ChromeDriver driver;
	static String fpath;
	
	@Test(dataProvider="dp_emi",dataProviderClass= dp_EMI.class)
  public void EMICacl(Map<String,String> mp) throws IOException {
		...
		//Reporting
				...
				driver.findElement(By.id("one")).sendKeys(mp.get("Amount").replace(".0", ""));
				driver.findElement(By.id("two")).sendKeys(mp.get("rate"));
				driver.findElement(By.id("three")).sendKeys(mp.get("tenure").replace(".0", ""));
