...
public class Scenario_Login {
	...
	@Test(dataProvider = "ValidLogin",dataProviderClass = AFD_dataProvider.Dp_Login.class)
	...
	@Test(dataProvider = "InValidLogin",dataProviderClass = AFD_dataProvider.Dp_Login.class, enabled=false)
